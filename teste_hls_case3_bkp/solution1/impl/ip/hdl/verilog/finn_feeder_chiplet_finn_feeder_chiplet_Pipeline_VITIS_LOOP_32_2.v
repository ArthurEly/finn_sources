...
module finn_feeder_chiplet_finn_feeder_chiplet_Pipeline_VITIS_LOOP_32_2 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
input  [29:0] trunc_ln28_1;
input  [60:0] sext_ln25;
...
wire   [39:0] pixel_data_fu_129_p1;
reg   [39:0] pixel_data_reg_149;
reg   [29:0] p_fu_66;
wire   [29:0] add_ln32_fu_112_p2;
wire    ap_loop_init;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln32_fu_106_p2 == 1'd0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln32_fu_106_p2 == 1'd1))) begin
...
assign add_ln32_fu_112_p2 = (ap_sig_allocacmp_p_1 + 30'd1);
...
assign icmp_ln32_fu_106_p2 = ((ap_sig_allocacmp_p_1 == trunc_ln28_1) ? 1'b1 : 1'b0);
...
assign out_stream_TDATA = pixel_data_reg_149;

assign pixel_data_fu_129_p1 = m_axi_gmem_RDATA[39:0];

endmodule //finn_feeder_chiplet_finn_feeder_chiplet_Pipeline_VITIS_LOOP_32_2

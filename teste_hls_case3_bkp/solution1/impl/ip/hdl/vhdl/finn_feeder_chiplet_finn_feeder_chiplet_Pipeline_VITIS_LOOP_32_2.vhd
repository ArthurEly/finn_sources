...
entity finn_feeder_chiplet_finn_feeder_chiplet_Pipeline_VITIS_LOOP_32_2 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
    ...
    trunc_ln28_1 : IN STD_LOGIC_VECTOR (29 downto 0);
    sext_ln25 : IN STD_LOGIC_VECTOR (60 downto 0);
    out_stream_TDATA : OUT STD_LOGIC_VECTOR (39 downto 0);
    out_stream_TVALID : OUT STD_LOGIC );
end;


architecture behav of finn_feeder_chiplet_finn_feeder_chiplet_Pipeline_VITIS_LOOP_32_2 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln32_fu_106_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal pixel_data_fu_129_p1 : STD_LOGIC_VECTOR (39 downto 0);
    signal pixel_data_reg_149 : STD_LOGIC_VECTOR (39 downto 0);
    signal p_fu_66 : STD_LOGIC_VECTOR (29 downto 0) := "000000000000000000000000000000";
    signal add_ln32_fu_112_p2 : STD_LOGIC_VECTOR (29 downto 0);
...
begin
    ...
    p_fu_66_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (icmp_ln32_fu_106_p2 = ap_const_lv1_0))) then 
                    p_fu_66 <= add_ln32_fu_112_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    p_fu_66 <= ap_const_lv30_0;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                pixel_data_reg_149 <= pixel_data_fu_129_p1;
            end if;
        end if;
    end process;
    ...
    add_ln32_fu_112_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_p_1) + unsigned(ap_const_lv30_1));
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln32_fu_106_p2)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln32_fu_106_p2 = ap_const_lv1_1))) then 
    ...
    ap_sig_allocacmp_p_1_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, p_fu_66, ap_loop_init)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
            ap_sig_allocacmp_p_1 <= ap_const_lv30_0;
        else 
            ap_sig_allocacmp_p_1 <= p_fu_66;
        end if; 
    end process;
    ...
    icmp_ln32_fu_106_p2 <= "1" when (ap_sig_allocacmp_p_1 = trunc_ln28_1) else "0";
    ...
    out_stream_TDATA <= pixel_data_reg_149;
    ...
    pixel_data_fu_129_p1 <= m_axi_gmem_RDATA(40 - 1 downto 0);
end behav;

...
__xlx_ext_mem_done_irq__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_done_irq)[i]);
  ...
  char* __xlx_out_stream_V_data_V_input_buffer= new char[ap_apatb_out_stream_V_data_V_cap_bc];
auto* sout_stream_V_data_V = createStream((hls::stream<char>*)__xlx_apatb_param_out_stream_V_data_V);
auto* sin_stream_V_data_V = createStream((hls::stream<char>*)__xlx_apatb_param_in_stream_V_data_V);
  // DUT call
  finn_feeder_chiplet(__xlx_ext_mem_done_irq__tmp_vec.data(), sout_stream_V_data_V->data<char>(), sin_stream_V_data_V->data<char>(), __xlx_apatb_param_predicted_index, __xlx_offset_byte_param_ext_mem, __xlx_apatb_param_initial_address, __xlx_apatb_param_image_size, __xlx_apatb_param_num_images, __xlx_offset_byte_param_done_irq);
...
sout_stream_V_data_V->transfer((hls::stream<char>*)__xlx_apatb_param_out_stream_V_data_V);

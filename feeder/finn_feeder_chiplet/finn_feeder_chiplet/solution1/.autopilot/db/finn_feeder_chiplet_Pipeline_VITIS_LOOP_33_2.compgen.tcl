...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { out_stream_TREADY { I 1 bit } out_stream_TDATA { O 8 vector } out_stream_TVALID { O 1 bit } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_conv3_i_i_i45 \
    op interface \
    ports { conv3_i_i_i45 { I 32 vector } } \
} "
}
...
set InstName finn_feeder_chiplet_flow_control_loop_pipe_sequential_init_U
set CompName finn_feeder_chiplet_flow_control_loop_pipe_sequential_init

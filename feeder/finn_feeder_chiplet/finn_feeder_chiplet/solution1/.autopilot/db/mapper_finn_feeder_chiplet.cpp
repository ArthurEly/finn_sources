...
using hls::sim::Byte;
extern "C" void finn_feeder_chiplet(Byte<4>*, volatile void *, volatile void *, volatile void *, int, int, int, int, volatile void *);
...
using hls::sim::createStream;
  // Collect __xlx_ext_mem__tmp_vec
std::vector<Byte<4>> __xlx_ext_mem__tmp_vec;
for (size_t i = 0; i < 1; ++i){
__xlx_ext_mem__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_ext_mem)[i]);
}
...
auto* sin_stream_V_data_V = createStream((hls::stream<char>*)__xlx_apatb_param_in_stream_V_data_V);
  // DUT call
  finn_feeder_chiplet(__xlx_ext_mem__tmp_vec.data(), sout_stream_V_data_V->data<char>(), sin_stream_V_data_V->data<char>(), __xlx_apatb_param_predicted_index, __xlx_offset_byte_param_ext_mem, __xlx_apatb_param_initial_address, __xlx_apatb_param_image_size, __xlx_apatb_param_num_images, __xlx_apatb_param_done_irq);
// print __xlx_apatb_param_ext_mem
for (size_t i = 0; i < __xlx_size_param_ext_mem; ++i) {
((Byte<4>*)__xlx_apatb_param_ext_mem)[i] = __xlx_ext_mem__tmp_vec[__xlx_offset_param_ext_mem+i];
}

...
#define AUTOTB_TVOUT_PC_done_irq "../tv/rtldatafile/rtl.finn_feeder_chiplet.autotvout_done_irq.dat"
...
void apatb_finn_feeder_chiplet_hw(void* __xlx_apatb_param_out_stream_V_data_V, void* __xlx_apatb_param_in_stream_V_data_V, void* __xlx_apatb_param_predicted_index, void* __xlx_apatb_param_ext_mem, hls::sim::Byte<4> __xlx_apatb_param_initial_address, hls::sim::Byte<4> __xlx_apatb_param_image_size, hls::sim::Byte<4> __xlx_apatb_param_num_images, void* __xlx_apatb_param_done_irq)
{
  ...
  port0.param = (hls::stream<hls::sim::Byte<1>>*)__xlx_apatb_param_out_stream_V_data_V;
  port0.hasWrite = true;
  ...
  static hls::sim::Register port7 {
    ...
    .width = 1,
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_done_irq),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_done_irq),
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_done_irq),
#endif
  };
  port7.param = __xlx_apatb_param_done_irq;
  ...
  port8.param = { __xlx_apatb_param_ext_mem };
  port8.nbytes = { 0 };
  port8.offset = {  };

...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "finn_feeder_chiplet.autotvin.dat"
	set constFileTvOut       "finn_feeder_chiplet.autotvout.dat"
	set constFileHdlTvIn     "finn_feeder_chiplet.autohdltvin.dat"
	set constFileHdlTvOut    "finn_feeder_chiplet.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"

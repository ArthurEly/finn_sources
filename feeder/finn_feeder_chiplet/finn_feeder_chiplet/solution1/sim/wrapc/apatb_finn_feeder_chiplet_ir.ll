; ModuleID = '/home/artti/Desktop/finn_fpga/finn_chiplet_projects/finn_chiplet_v2.0/feeder/finn_feeder_chiplet/finn_feeder_chiplet/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_finn_feeder_chiplet_ir(%"class.hls::stream<hls::axis<ap_uint<8>, 0, 0, 0, '\5Cx00', false>, 0>"* noalias nonnull dereferenceable(7) %out_stream, %"class.hls::stream<hls::axis<ap_uint<8>, 0, 0, 0, '\5Cx00', false>, 0>"* noalias nonnull dereferenceable(7) %in_stream, i8* noalias nonnull %predicted_index, i8* noalias nonnull %ext_mem, i32 %initial_address, i32 %image_size, i32 %num_images) local_unnamed_addr #0 {
entry:
  %out_stream_copy.data = alloca i8, align 512
  %in_stream_copy.data = alloca i8, align 512
  %predicted_index_copy = alloca i8, align 512
  %ext_mem_copy = alloca i8, align 512
  call fastcc void @copy_in(%"class.hls::stream<hls::axis<ap_uint<8>, 0, 0, 0, '\5Cx00', false>, 0>"* nonnull %out_stream, i8* nonnull align 512 %out_stream_copy.data, %"class.hls::stream<hls::axis<ap_uint<8>, 0, 0, 0, '\5Cx00', false>, 0>"* nonnull %in_stream, i8* nonnull align 512 %in_stream_copy.data, i8* nonnull %predicted_index, i8* nonnull align 512 %predicted_index_copy, i8* nonnull %ext_mem, i8* nonnull align 512 %ext_mem_copy)
  call void @apatb_finn_feeder_chiplet_hw(i8* %out_stream_copy.data, i8* %in_stream_copy.data, i8* %predicted_index_copy, i8* %ext_mem_copy, i32 %initial_address, i32 %image_size, i32 %num_images)
  call void @copy_back(%"class.hls::stream<hls::axis<ap_uint<8>, 0, 0, 0, '\5Cx00', false>, 0>"* %out_stream, i8* %out_stream_copy.data, %"class.hls::stream<hls::axis<ap_uint<8>, 0, 0, 0, '\5Cx00', false>, 0>"* %in_stream, i8* %in_stream_copy.data, i8* %predicted_index, i8* %predicted_index_copy, i8* %ext_mem, i8* %ext_mem_copy)
  ret void
}

; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @copy_in(%"class.hls::stream<hls::axis<ap_uint<8>, 0, 0, 0, '\5Cx00', false>, 0>"* noalias, i8* noalias align 512 "unpacked"="1.0" %_V_data_V, %"class.hls::stream<hls::axis<ap_uint<8>, 0, 0, 0, '\5Cx00', false>, 0>"* noalias, i8* noalias align 512 "unpacked"="3.0" %_V_data_V1, i8* noalias readonly, i8* noalias align 512, i8* noalias readonly, i8* noalias align 512) unnamed_addr #1 {
entry:
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @copy_out(%"class.hls::stream<hls::axis<ap_uint<8>, 0, 0, 0, '\5Cx00', false>, 0>"* noalias, i8* noalias align 512 "unpacked"="1.0" %_V_data_V, %"class.hls::stream<hls::axis<ap_uint<8>, 0, 0, 0, '\5Cx00', false>, 0>"* noalias, i8* noalias align 512 "unpacked"="3.0" %_V_data_V1, i8* noalias, i8* noalias readonly align 512, i8* noalias, i8* noalias readonly align 512) unnamed_addr #3 {
entry:
...
declare void @apatb_finn_feeder_chiplet_hw(i8*, i8*, i8*, i8*, i32, i32, i32)

; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @copy_back(%"class.hls::stream<hls::axis<ap_uint<8>, 0, 0, 0, '\5Cx00', false>, 0>"* noalias, i8* noalias align 512 "unpacked"="1.0" %_V_data_V, %"class.hls::stream<hls::axis<ap_uint<8>, 0, 0, 0, '\5Cx00', false>, 0>"* noalias, i8* noalias align 512 "unpacked"="3.0" %_V_data_V1, i8* noalias, i8* noalias readonly align 512, i8* noalias, i8* noalias readonly align 512) unnamed_addr #3 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<8>, 0, 0, 0, '\5Cx00', false>, 0>"(%"class.hls::stream<hls::axis<ap_uint<8>, 0, 0, 0, '\5Cx00', false>, 0>"* %0, i8* align 512 %_V_data_V)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<8>, 0, 0, 0, '\5Cx00', false>, 0>"(%"class.hls::stream<hls::axis<ap_uint<8>, 0, 0, 0, '\5Cx00', false>, 0>"* %1, i8* align 512 %_V_data_V1)
  call fastcc void @onebyonecpy_hls.p0i8(i8* %2, i8* align 512 %3)
...
define void @finn_feeder_chiplet_hw_stub_wrapper(i8*, i8*, i8*, i8*, i32, i32, i32) #6 {
entry:
  %7 = alloca %"class.hls::stream<hls::axis<ap_uint<8>, 0, 0, 0, '\5Cx00', false>, 0>"
  %8 = alloca %"class.hls::stream<hls::axis<ap_uint<8>, 0, 0, 0, '\5Cx00', false>, 0>"
  call void @copy_out(%"class.hls::stream<hls::axis<ap_uint<8>, 0, 0, 0, '\5Cx00', false>, 0>"* %7, i8* %0, %"class.hls::stream<hls::axis<ap_uint<8>, 0, 0, 0, '\5Cx00', false>, 0>"* %8, i8* %1, i8* null, i8* %2, i8* null, i8* %3)
  call void @finn_feeder_chiplet_hw_stub(%"class.hls::stream<hls::axis<ap_uint<8>, 0, 0, 0, '\5Cx00', false>, 0>"* %7, %"class.hls::stream<hls::axis<ap_uint<8>, 0, 0, 0, '\5Cx00', false>, 0>"* %8, i8* %2, i8* %3, i32 %4, i32 %5, i32 %6)
  call void @copy_in(%"class.hls::stream<hls::axis<ap_uint<8>, 0, 0, 0, '\5Cx00', false>, 0>"* %7, i8* %0, %"class.hls::stream<hls::axis<ap_uint<8>, 0, 0, 0, '\5Cx00', false>, 0>"* %8, i8* %1, i8* null, i8* %2, i8* null, i8* %3)
  ret void
}

declare void @finn_feeder_chiplet_hw_stub(%"class.hls::stream<hls::axis<ap_uint<8>, 0, 0, 0, '\5Cx00', false>, 0>"*, %"class.hls::stream<hls::axis<ap_uint<8>, 0, 0, 0, '\5Cx00', false>, 0>"*, i8*, i8*, i32, i32, i32)

...
if {[file isfile finn_feeder_chiplet.autotvin.dat]} {
	file delete -force finn_feeder_chiplet.autotvin.dat
}

if {[file isfile finn_feeder_chiplet.autotvout.dat]} {
	file delete -force finn_feeder_chiplet.autotvout.dat
}

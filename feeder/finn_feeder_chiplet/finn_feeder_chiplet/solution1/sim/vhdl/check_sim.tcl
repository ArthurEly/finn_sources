...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.finn_feeder_chiplet.autotvin_INPUT_STREAM_V_data_V.dat"
         "c.finn_feeder_chiplet.autotvin_ext_mem.dat"
         "c.finn_feeder_chiplet.autotvin_image_size.dat"
         "c.finn_feeder_chiplet.autotvin_num_images.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.finn_feeder_chiplet.autotvout_OUTPUT_STREAM_V_data_V.dat"
         "rtl.finn_feeder_chiplet.autotvout_predicted_index.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {

...
attribute shreg_extract : string;
    ...
    signal icmp_ln41_fu_153_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_block_state13_pp0_stage0_iter3 : BOOLEAN;
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal icmp_ln41_reg_269_pp0_iter1_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln41_reg_269_pp0_iter2_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal gmem_addr_reg_273 : STD_LOGIC_VECTOR (63 downto 0);
    signal pixel_data_fu_228_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal pixel_data_reg_279 : STD_LOGIC_VECTOR (7 downto 0);
    signal ap_block_state2_io : BOOLEAN;
    signal ap_block_state10_pp0_stage1_iter2 : BOOLEAN;
    signal ap_block_state14_pp0_stage1_iter3 : BOOLEAN;
    signal ap_block_pp0_stage1_11001 : BOOLEAN;
    signal pixel_data_1_reg_284 : STD_LOGIC_VECTOR (7 downto 0);
    signal pixel_data_2_reg_289 : STD_LOGIC_VECTOR (7 downto 0);
    signal pixel_data_3_reg_294 : STD_LOGIC_VECTOR (7 downto 0);
    signal ap_enable_reg_pp0_iter0_reg : STD_LOGIC := '0';
    signal ap_block_pp0_stage1_subdone : BOOLEAN;
    signal sext_ln43_fu_213_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal p_fu_94 : STD_LOGIC_VECTOR (29 downto 0) := "000000000000000000000000000000";
    signal add_ln41_fu_159_p2 : STD_LOGIC_VECTOR (29 downto 0);
    ...
    signal shr_cast_cast_fu_141_p1 : STD_LOGIC_VECTOR (30 downto 0);
    signal zext_ln43_fu_165_p1 : STD_LOGIC_VECTOR (30 downto 0);
    signal add_ln43_2_fu_169_p2 : STD_LOGIC_VECTOR (30 downto 0);
    signal zext_ln43_1_fu_175_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal add_ln43_fu_179_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal shl_ln_fu_185_p3 : STD_LOGIC_VECTOR (33 downto 0);
    signal zext_ln43_2_fu_193_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal add_ln43_1_fu_197_p2 : STD_LOGIC_VECTOR (63 downto 0);
    signal trunc_ln1_fu_203_p4 : STD_LOGIC_VECTOR (61 downto 0);
...
begin
    ...
    p_fu_94_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (icmp_ln41_fu_153_p2 = ap_const_lv1_0))) then 
                    p_fu_94 <= add_ln41_fu_159_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    p_fu_94 <= ap_const_lv30_0;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage1_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then
                pixel_data_1_reg_284 <= m_axi_gmem_RDATA(15 downto 8);
                pixel_data_2_reg_289 <= m_axi_gmem_RDATA(23 downto 16);
                pixel_data_3_reg_294 <= m_axi_gmem_RDATA(31 downto 24);
    ...
    add_ln41_fu_159_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_p_1) + unsigned(ap_const_lv30_1));
    add_ln43_1_fu_197_p2 <= std_logic_vector(unsigned(zext_ln43_2_fu_193_p1) + unsigned(ext_mem));
    add_ln43_2_fu_169_p2 <= std_logic_vector(unsigned(shr_cast_cast_fu_141_p1) + unsigned(zext_ln43_fu_165_p1));
    add_ln43_fu_179_p2 <= std_logic_vector(unsigned(zext_ln43_1_fu_175_p1) + unsigned(mul_ln38));
    ...
    ap_block_state2_io_assign_proc : process(icmp_ln41_reg_269, m_axi_gmem_ARREADY)
    begin
                ap_block_state2_io <= ((m_axi_gmem_ARREADY = ap_const_logic_0) and (icmp_ln41_reg_269 = ap_const_lv1_0));
    end process;


    ap_condition_exit_pp0_iter0_stage3_assign_proc : process(ap_enable_reg_pp0_iter0, ap_CS_fsm_pp0_stage3, ap_block_pp0_stage3_subdone, icmp_ln41_reg_269)
    begin
        if (((icmp_ln41_reg_269 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage3_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage3))) then 
    ...
    ap_condition_exit_pp0_iter2_stage1_assign_proc : process(ap_enable_reg_pp0_iter2, ap_CS_fsm_pp0_stage1, icmp_ln41_reg_269_pp0_iter2_reg, ap_block_pp0_stage1_subdone)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage1_subdone) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (icmp_ln41_reg_269_pp0_iter2_reg = ap_const_lv1_1))) then 
    ...
    ap_sig_allocacmp_p_1_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, p_fu_94, ap_loop_init)
    begin
    ...
    gmem_blk_n_AR_assign_proc : process(ap_enable_reg_pp0_iter0, icmp_ln41_reg_269, m_axi_gmem_ARREADY, ap_CS_fsm_pp0_stage1, ap_block_pp0_stage1)
    begin
        if (((icmp_ln41_reg_269 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage1) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then 
    ...
    icmp_ln41_fu_153_p2 <= "1" when (ap_sig_allocacmp_p_1 = shr1) else "0";
    m_axi_gmem_ARADDR <= gmem_addr_reg_273;
    ...
    m_axi_gmem_ARVALID_assign_proc : process(ap_enable_reg_pp0_iter0, icmp_ln41_reg_269, ap_CS_fsm_pp0_stage1, ap_block_pp0_stage1_11001)
    begin
        if (((icmp_ln41_reg_269 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage1_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then 
    ...
    out_stream_TDATA_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter2, ap_enable_reg_pp0_iter3, ap_CS_fsm_pp0_stage3, ap_CS_fsm_pp0_stage1, ap_CS_fsm_pp0_stage2, pixel_data_reg_279, pixel_data_1_reg_284, pixel_data_2_reg_289, pixel_data_3_reg_294, ap_block_pp0_stage2_01001, ap_block_pp0_stage3_01001, ap_block_pp0_stage0_01001, ap_block_pp0_stage1_01001)
    begin
    ...
    pixel_data_fu_228_p1 <= m_axi_gmem_RDATA(8 - 1 downto 0);
        sext_ln43_fu_213_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(trunc_ln1_fu_203_p4),64));

    shl_ln_fu_185_p3 <= (add_ln43_fu_179_p2 & ap_const_lv2_0);
    shr_cast_cast_fu_141_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(shr_cast),31));
    trunc_ln1_fu_203_p4 <= add_ln43_1_fu_197_p2(63 downto 2);
    zext_ln43_1_fu_175_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln43_2_fu_169_p2),32));
    zext_ln43_2_fu_193_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(shl_ln_fu_185_p3),64));
    zext_ln43_fu_165_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_p_1),31));
end behav;
